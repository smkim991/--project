...
namespace WindowsFormsApp15
{
    public partial class Form3 : Form
    {
        ...
        public Form3(Dictionary<string, List<string>> initialBlockedItems)
        {
            InitializeComponent();
            InitializeAllBlockableItems(); // 모든 차단 가능 항목 초기화

            // Form1에서 전달받은 데이터를 Form3의 modeBlockedItems에 복사
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            this.DialogResult = DialogResult.OK; // Form1으로 OK 결과를 반환
            this.Close();
        }
    }
}
